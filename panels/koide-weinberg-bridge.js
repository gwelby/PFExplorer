          ...
          '<div class="panel-atlas">' +
            '<section class="canvas-panel" style="position:relative">' +
              '<div class="panel-header">' +
                '<div>' +
                  '<p class="eyebrow"><span style="color:#ff4455; font-family:serif; margin-right:4px;">✕</span> RG Running Analysis</p>' +
                  ...
                  '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Review the results of T-021 and T-022 below. Notice how the gap remains distinct.</p>' +
                '</div>' +
              '</div>' +
