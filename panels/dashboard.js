      ...
      ctx.stage.innerHTML =
        "<div class=\"panel-wrap\">" +
          "<section class=\"hero-panel\">" +
            "<div class=\"hero-copy\">" +
              "<p class=\"eyebrow\"><span style=\"color:#ffdd55; font-family:serif; margin-right:4px;\">⚗</span> The Audit Wall</p>" +
              ...
              "<p class=\"interaction-cue\" style=\"color:var(--muted); font-size:12px; margin-top:8px;\"><strong>Interaction:</strong> Filter results by status, search by keyword, or toggle to the topological Derivation Graph view.</p>" +
