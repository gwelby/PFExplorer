          ...
          "<div class=\"panel-atlas\">" +
            "<section class=\"canvas-panel\">" +
              "<div class=\"panel-header\">" +
                "<div>" +
                  "<p class=\"eyebrow\"><span style=\"color:#44ff88; font-family:serif; margin-right:4px;\">⌁</span> Refraction Sandbox</p>" +
                  ...
                  "<p class=\"interaction-cue\" style=\"color:var(--muted); font-size:12px; margin-top:8px;\"><strong>Interaction:</strong> Click empty space to place a source. Drag existing sources to reshape the field. Toggle 'Overlay' to compare with Newton's predictions.</p>" +
                "</div>" +
              "</div>" +
