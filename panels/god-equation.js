          ...
          '<div class="panel-atlas">' +
            '<section class="canvas-panel" style="position:relative">' +
              '<div class="panel-header">' +
                '<div>' +
                  '<p class="eyebrow"><span style="color:#ffaa33; font-family:serif; margin-right:4px;">Λ</span> Planck to Matter</p>' +
                  ...
                  '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Use the sliders below to explore the exponential hierarchy from the Planck scale. Review the current frontier analysis.</p>' +
                '</div>' +
              '</div>' +
