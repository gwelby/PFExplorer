          ...
          "<div class=\"panel-atlas\">" +
            "<section class=\"canvas-panel\">" +
              "<div class=\"panel-header\">" +
                "<div>" +
                  "<p class=\"eyebrow\"><span style=\"color:#44ff88; font-family:serif; margin-right:4px;\">θ</span> Casimir Polynomial</p>" +
                  ...
                  "<p class=\"interaction-cue\" style=\"color:var(--muted); font-size:12px; margin-top:8px;\"><strong>Interaction:</strong> Follow the roots and the mixing angle derivation. Review the explicit scheme caveat below.</p>" +
                "</div>" +
              "</div>" +
