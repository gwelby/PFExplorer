          ...
          '<div class="panel-atlas">' +
            '<section class="canvas-panel" style="position:relative">' +
              '<div class="panel-header">' +
                '<div>' +
                  '<p class="eyebrow"><span style="color:#44ff88; font-family:serif; margin-right:4px;">⟁</span> Mass Geometry</p>' +
                  ...
                  '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Select a mass and use the slider to perturb its value. Observe the real-time geometric distortion and Q deviation.</p>' +
                '</div>' +
              '</div>' +
