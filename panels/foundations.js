      ...
      stage.innerHTML =
        "<div class=\"panel-wrap\">" +
          "<section class=\"hero-panel\">" +
            "<div class=\"hero-copy\">" +
              "<p class=\"eyebrow\"><span style=\"color:#00cfff; font-family:serif; margin-right:4px;\">∇</span> Axiomatic Foundations Lab</p>" +
              ...
              "<p class=\"interaction-cue\" style=\"color:var(--muted); font-size:12px; margin-top:8px;\"><strong>Interaction:</strong> Select an axiom to switch views. Drag the Falsification slider to inject thermal noise and test structural collapse.</p>" +
            "</div>" +
            "<div class=\"stat-grid\">" +
