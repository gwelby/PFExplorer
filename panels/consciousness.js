          ...
          '<div class="panel-atlas">' +
            '<section class="canvas-panel">' +
              '<div class="panel-header">' +
                '<div>' +
                  '<p class="eyebrow"><span style="color:rgba(255,255,255,.5); font-family:serif; margin-right:4px;">∞</span> Neural Scale — 10⁻² m</p>' +
                  '<h3>Consciousness = Coherent Self-Reference</h3>' +
                  '<p>The same coherence that creates matter and orbits — turned inward, on itself.</p>' +
                  '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Observe the self-referential loop representing the inward turning of coherence.</p>' +
                '</div>' +
              '</div>' +
