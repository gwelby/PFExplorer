        ...
        '<div class="eb-shell">',
          '<section class="eb-hero">',
            '<div class="eb-hero-text">',
              '<p class="eb-eyebrow"><span style="color:#ffdd55; font-family:serif; margin-right:4px;">⚗</span> The Audit Wall</p>',
              ...
              '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Filter claims by status using the tabs. Click on any claim to open the detailed Evidence Drawer.</p>',
            '</div>',
            '<div class="eb-stats">',
