        ...
        '<div class="atlas-shell">',
          '<div class="atlas-header">',
            '<div class="atlas-header-text">',
              '<h2 class="atlas-headline"><span style="color:#ffdd55; font-family:serif;">◈</span> Proof Atlas</h2>',
              ...
              '<p class="atlas-interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Drag to pan. Scroll to zoom. Click any node to open the Evidence Drawer for its full derivation.</p>',
            '</div>',
