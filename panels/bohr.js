          ...
          '<div class="panel-atlas">' +
            '<section class="canvas-panel" style="position:relative">' +
              '<div class="panel-header">' +
                '<div>' +
                  '<p class="eyebrow"><span style="color:#ffaa33; font-family:serif; margin-right:4px;">ψ</span> Phase Closure Orbit</p>' +
                  ...
                  '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Drag the slider to vary the orbit radius. Observe how only integer winding numbers (k) survive phase closure.</p>' +
                '</div>' +
              '</div>' +
