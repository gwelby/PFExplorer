      ...
      '<div class="dl-shell">',
        '<div class="dl-sidebar">',
          '<div class="dl-sidebar-head">',
            '<h3 class="dl-sidebar-title">The Vocabulary of Reality</h3>',
        ...
        '<div class="dl-graph-pane">',
          '<div class="dl-graph-head">',
            ...
            '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Click any node to navigate to its details in the sidebar.</p>',
          '</div>',
