          ...
          "<div class=\"panel-atlas\">" +
            "<section class=\"canvas-panel\">" +
              "<div class=\"panel-header\">" +
                "<div>" +
                  "<p class=\"eyebrow\"><span style=\"color:#ffaa33; font-family:serif; margin-right:4px;\">N³</span> π₁(SO(3)) = ℤ₂</p>" +
                  ...
                  "<p class=\"interaction-cue\" style=\"color:var(--muted); font-size:12px; margin-top:8px;\"><strong>Interaction:</strong> Click 'Animate 720°' to untangle the ribbon by rotating it fully twice. Adjust the generation count N below.</p>" +
                "</div>" +
              "</div>" +
