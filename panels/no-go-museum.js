      ...
      '<div class="ng-shell">',
        '<div class="ng-header">',
          '<div class="ng-header-text">',
            '<h2 class="ng-headline"><span style="color:#ff4455; font-family:serif; margin-right:4px;">✕</span> The Museum of Honest Failures</h2>',
            '<p class="ng-subhead">Every red line here is a victory. In physics, knowing exactly where the wall is proves that the room exists. We celebrate these 13 closures because they protected us from the wrong intuitions.</p>',
            '<p class="interaction-cue" style="color:var(--muted); font-size:12px; margin-top:8px;"><strong>Interaction:</strong> Click the "Attacked" target link to jump to the derivation node that invalidated the route. Review the intuitive trap for each.</p>',
          '</div>',
