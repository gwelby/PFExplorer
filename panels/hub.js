(function () {
  ...
  window.PFExplorer.registerPanel({
      ...
      stage.innerHTML =
        "<div class=\"panel-wrap\">" +
          "<section class=\"hero-panel\">" +
            "<div class=\"hero-copy\">" +
              "<p class=\"eyebrow\"><span style=\"color:#00cfff; font-family:serif; margin-right:4px;\">↕</span> Scale Stack Navigator</p>" +
              ...
              "<p class=\"interaction-cue\" style=\"color:var(--muted); font-size:12px; margin-top:8px;\"><strong>Interaction:</strong> Orbit the 3D ladder. Click a floating scale node to load its mapped results.</p>" +
    ...
    init3D: function(ctx) {
      ...
      var pMat = new THREE.PointsMaterial({ color: 0xffffff, size: 0.08, transparent: true, opacity: 0.3 });
